...
from classes.spotify import Track, Album, Artist, Error

TRACK_URL = 'https://api.spotify.com/v1/tracks/'
ALBUM_URL = 'https://api.spotify.com/v1/albums/'
ARTIST_URL = 'https://api.spotify.com/v1/artists/'
PLAYLIST_URL = 'https://api.spotify.com/v1/users/'
BROWSE_URL = 'https://api.spotify.com/v1/browse/'
...
def get_track(track_id):
    track_json = get_track_dict(track_id)
    if "error" in track_json:
        return Error(track_json)
